...
#define SCK0_PORT 		3
#define SCK0_PIN 		3
#define SCK0_SCU_FUNC 	SCU_MODE_FUNC2
#define SSEL0_PORT 		3
#define SSEL0_PIN 		6
...
#define MOSI0_PORT 		3
#define MOSI0_PIN 		8
#define MOSI0_SCU_FUNC 	SCU_MODE_FUNC2
#define MISO0_PORT		3
#define MISO0_PIN 		7
#define MISO0_SCU_FUNC 	SCU_MODE_FUNC2
...
//#define SCK0_PORT 0
//#define SCK0_PIN 0
#define SCK1_SCU_FUNC SCU_MODE_FUNC0
#define SSEL1_PORT 0
#define SSEL1_PIN 0
#define SSEL1_SCU_FUNC SCU_MODE_FUNC0
#define MOSI1_PORT 0
#define MOSI1_PIN 0
#define MOSI1_SCU_FUNC SCU_MODE_FUNC0
#define MISO1_PORT 0
#define MISO1_PIN 0
#define MISO1_SCU_FUNC SCU_MODE_FUNC0
#define SSP1_BITS_PER_FRAME SSP_BITS_16
...
/*************************SPIFI***************************/
#define SPIFI_CLK_PORT 				0
#define SPIFI_CLK_PIN				0
#define SPIFI_CLK_SCU_MODE_FUNC		SCU_MODE_FUNC0

#define SPIFI_D3_PORT 				0
#define SPIFI_D3_PIN				0
#define SPIFI_D3_SCU_MODE_FUNC		SCU_MODE_FUNC0

#define SPIFI_D2_PORT 				0
#define SPIFI_D2_PIN				0
#define SPIFI_D2_SCU_MODE_FUNC		SCU_MODE_FUNC0

#define SPIFI_D1_PORT 				0
#define SPIFI_D1_PIN				0
#define SPIFI_D1_SCU_MODE_FUNC		SCU_MODE_FUNC0

#define SPIFI_D0_PORT 				0
#define SPIFI_D0_PIN				0
#define SPIFI_D0_SCU_MODE_FUNC		SCU_MODE_FUNC0

#define SPIFI_CS_PORT 				0
#define SPIFI_CS_PIN				0
#define SPIFI_CS_SCU_MODE_FUNC		SCU_MODE_FUNC0
...
#define UART0_TX_PORT 0xF
#define UART0_TX_PIN 10
#define UART0_TX_SCU_FUNC SCU_MODE_FUNC1
#define UART0_RX_PORT 0xF
#define UART0_RX_PIN 11
#define UART0_RX_SCU_FUNC SCU_MODE_FUNC1

#define UART1_TX_PORT 0xC
#define UART1_TX_PIN 13
#define UART1_TX_SCU_FUNC SCU_MODE_FUNC2
#define UART1_RX_PORT 0xC
#define UART1_RX_PIN 14
#define UART1_RX_SCU_FUNC SCU_MODE_FUNC2
...
#define UART3_TX_SCU_FUNC SCU_MODE_FUNC2
#define UART3_RX_PORT 2
#define UART3_RX_PIN 4
#define UART3_RX_SCU_FUNC SCU_MODE_FUNC2
...
#pragma pack(push, 1)
typedef struct BOARD_GPIO_struct
{
	unsigned char port;
	unsigned char pin;
	unsigned char gpio_port;
	unsigned char gpio_pin;
	unsigned char scu_mode;
}BOARD_GPIO_t;
#pragma pack(pop)
...
#define LED0_PORT 6
#define LED0_PIN 6
#define LED0_GPIOPORT 0
#define LED0_GPIOPIN 5
#define LED0_SCU_MODE_FUNC SCU_MODE_FUNC0

#define LED1_PORT 0xD
#define LED1_PIN 14
#define LED1_GPIOPORT 6
#define LED1_GPIOPIN 28
#define LED1_SCU_MODE_FUNC SCU_MODE_FUNC4

#define LED2_PORT 0xD
#define LED2_PIN 12
#define LED2_GPIOPORT 6
#define LED2_GPIOPIN 26
#define LED2_SCU_MODE_FUNC SCU_MODE_FUNC4

#define LED3_PORT 0xD
#define LED3_PIN 10
#define LED3_GPIOPORT 6
#define LED3_GPIOPIN 24
#define LED3_SCU_MODE_FUNC SCU_MODE_FUNC4

#define LED4_PORT 0xD
#define LED4_PIN 11
#define LED4_GPIOPORT 6
#define LED4_GPIOPIN 25
...
#define ETH_CRS_DV_MODE_FUNC		SCU_MODE_FUNC3
#define ETH_MDIO_PORT	 			1
#define ETH_MDIO_PIN 				17
#define ETH_MDIO_MODE_FUNC			SCU_MODE_FUNC3
#define ETH_MDC_PORT	 			0xC
#define ETH_MDC_PIN 				1
#define ETH_MDC_MODE_FUNC			SCU_MODE_FUNC3
...
#define ETH_PHY_RESET_PORT	 		4
#define ETH_PHY_RESET_PIN 			5
#define ETH_PHY_RESET_GPIO_PORT	 	2
#define ETH_PHY_RESET_GPIO_PIN 		5
...
//cc1200
#define CC1200_SSP_num 0

#define CC1200_GPIO_PORT 			0xB
#define CC1200_GPIO_PIN 			1
#define CC1200_GPIO_GPIOPORT 		5
#define CC1200_GPIO_GPIOPIN 		21
#define CC1200_GPIO_SCU_MODE_FUNC 	SCU_MODE_FUNC4
